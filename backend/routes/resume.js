...
import { uploadResumes, rankCandidates, compareCandidate, getSessionResumes, getUserSessions, createSession, deleteResume, renameSession, getJobStatus } from "../controllers/resumeController.js";
...
router.post("/compare", compareCandidate);
